...
class ArticleSlugificationService
{
    /**
     ...
     */
    public function generateArticleSlug(string $title, callable $checkExists): string
    {
        return $this->generateUniqueSlug($title, $checkExists);
    }
}
