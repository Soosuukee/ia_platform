...
class ClientSlugificationService
{
    /**
    ...
    /**
     * Génère un slug pour un client basé sur son nom
     */
    public function generateClientSlug(string $firstName, string $lastName, callable $checkExists): string
    {
